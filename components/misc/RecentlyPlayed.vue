<template>
  <div>
    <h5 class="border3 ml-1 mr-1 pt-3" style="margin-bottom:15px;">Recently Played</h5> <n-link to="recently-played"><small>View More</small></n-link>
    <b-row align-h="center" class="news1-home-articles ml-1">
      <div :key="item.uuid" v-for="item in songs">
        <div>
          <div>
            <div style="width: 130px; height: 190px; overflow: hidden;padding-right:15px;">
              <v-lazy-image v-if="item.song.graphic.small != null" src-placeholder="~assets/images/main/r-small.webp" height=120 width=120 :src="item.song.graphic.medium" style="border-radius:5px;"  />
