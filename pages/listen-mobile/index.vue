  ...
  <div class="page">
    ...
    <div class="centeredstuff">
      ...
      <div class="mb-2 ml-2" v-for="station in stations" :key="station.uuid">
        <p><n-link :to='"/listen-mobile/"+station.slug' class="btn btn-primary" style="width: 75%; color: white;">{{station.name}}</n-link></p>
      </div>
    </div>
  </div>
</template>
...
import Navbar from '~/components/header/mobile-navbar-2.vue' 
  export default {
    components:{
      Navbar
    },
