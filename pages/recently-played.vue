<template>
  <div class="page">
    <section class="container" style="margin-bottom:150px;">
      <div>
        <h5 class="border3 ml-1 mr-1 pt-4" style="margin-bottom:15px;">Recently Played</h5>
        <b-row align-h="center" style="padding-bottom: 50px;">
          <div v-for="item in songs" :key="item.uuid">
          <div class="mb-2 ml-2">
            <div>
              <div class="home-pbox" style="width: 140px;min-height: 250px;border-radius:2.5%;margin:5px;">
                <a :href="item.song.extraInfo.trackUrl" v-if="item.song.graphic.large != null" target="_blank"><v-lazy-image v-if="item.song.graphic.large != null" src-placeholder="~assets/images/main/r-small.webp" :src="item.song.graphic.large" style="width: 140px; height: 140px; object-fit: cover;border-top-left-radius:2.5%;border-top-right-radius:2.5%;"></v-lazy-image></a>
                <v-lazy-image v-else src="~assets/images/main/r-small.webp" style="width: 170px; height: 140px; object-fit: cover"></v-lazy-image>
