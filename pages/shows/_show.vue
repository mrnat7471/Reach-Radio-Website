<template>
  <div class="page" id="news3" style="margin-bottom:150px;">
    <section class="container pt-4 pb-1">
      <b-row>
        <b-col md="9">
          <div style="text-align:center;padding-top:0px;margin: auto;width: 50%;">
            <div>
              <p style="text-align:center;"><img :src="shows2.fields.presenterImage" style="height:200px;" /></p>
            </div>
          </div>
          <div style="text-align:center!important">
            <h2 class="border3 mb-1"><b>{{shows2.fields.show}} with {{shows2.fields.presenter}} {{shows2.fields.presenterLastName}}</b></h2>
...
<script>
  ...
  export default {
    ...
    data() {
      return{
        presentertimes: [
          { name: "Arran", time: moment().unix()-604800},
          ...
          { name: "Ellis", time: moment().unix()-1814400},
