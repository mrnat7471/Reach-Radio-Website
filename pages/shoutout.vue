...
<div class="page">
  <section class="container pt-3">
          ...
          <form class="pb-3">
            ...
            <input class="form-control" id="name" name="name" required type="text" v-model="form.name"/>
            <label class="pt-2" for="comment">Message</label>
            <textarea class="form-control" cols="30" id="comment" name="comment" required rows="10" v-model="form.message"></textarea>
            <b-form-checkbox class="mt-3" id="acceptGdpr" name="acceptGdpr" required v-model="form.gdpr">
              I accept to my name being sent to Reach
            </b-form-checkbox>
