<template>
  <div id="news3" style="padding-top:10px;background-color: #181a1b;color:white;">
    <section class="container">
      <div class="pt-3 pb-3 text-white pl-3 pr-3 mt-3 standardheader2">
        <h4 style="padding-right: 10px;">{{article.title}} </h4>
      </div>
      <div :style="{ backgroundImage: `url('${article.featuredImage}')` }" style="filter: grayscale(100%);" class="news-bg"></div>
      <div class="pt-3 text-white pl-3 pr-3 mb-4 standardheader2">
