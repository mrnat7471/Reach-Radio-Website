<template>
  <div class="page" style="padding-bottom: 15px;">
    <section class="container pt-3">
      <h4 class="border3 ml-1 mr-1 pt-5" style="margin-bottom:15px;">The Reach Top 40</h4>
      <div v-if="charttoggle.fields.toggleOff == true" style="text-align: center;margin-left:15px;margin-right: 15px;margin-top:50px;margin-bottom:50px;">
        <h4>{{charttoggle.fields.pageContent}}</h4>
      </div>
      <div v-else>
        <div v-if="charts[0]">
          ...
          <div v-for="song in charts" :key="song.uuid">
            <div v-if="song.fields.song" class="mb-3">
              <div class="grid-container">
                <div class="position" style="background-color: black; color: white; padding-left: 4px; padding-right: 6px;">
                  <div style="width: auto;">
                    <strong><span style="font-size: 20px;">{{song.fields.songNumber}}</span></strong>
                  </div>
                </div>
                <div class="image">
                  <img :src="song.fields.song.graphic.medium" style="height: auto; width: 100%;">
                </div>
                <div class="details pl-3">
                  <h4 class="title">{{song.fields.song.title}}</h4>
                  <p>{{song.fields.song.artist}}</p>
                  <div class="dl-link-small" v-if="song.fields.song.extraInfo.trackUrl">
                    <a :href="song.fields.song.extraInfo.trackUrl">
                ...
                <div class="dl-link" v-if="song.fields.song.extraInfo.trackUrl">
                  <a :href="song.fields.song.extraInfo.trackUrl">
                    <img src="https://nathan7471.xyz/img/lAco9/MEbImAkA69.svg/raw">
                  </a>
                </div>
                <div class="dl-link" v-if="song.fields.song.extraInfo.track">
                  <a :href="song.fields.song.extraInfo.track.external_urls.spotify">
                    <img src="~assets/icons/spotify.png" style="width: 30px; height: auto; float: right;">
                  </a>
                </div>
              </div>
            </div>
